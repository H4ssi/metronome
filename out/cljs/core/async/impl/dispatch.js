...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13509 = (0);while(true){
var m_13510 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13510 == null))
{} else
{m_13510.call(null);
if((count_13509 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13511 = (count_13509 + (1));
count_13509 = G__13511;
continue;
}
} else
{}
