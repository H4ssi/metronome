...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13515 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13515 = (function (val,box,meta13516){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13515.cljs$lang$type = true;
cljs.core.async.impl.channels.t13515.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13515";
cljs.core.async.impl.channels.t13515.cljs$lang$ctorPrWriter = (function (this__4120__auto__,writer__4121__auto__,opt__4122__auto__){return cljs.core._write.call(null,writer__4121__auto__,"cljs.core.async.impl.channels/t13515");
});
cljs.core.async.impl.channels.t13515.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13515.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13517){var self__ = this;
var _13517__$1 = this;return self__.meta13516;
});
cljs.core.async.impl.channels.t13515.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13517,meta13516__$1){var self__ = this;
var _13517__$1 = this;return (new cljs.core.async.impl.channels.t13515(self__.val,self__.box,meta13516__$1));
});
cljs.core.async.impl.channels.__GT_t13515 = (function __GT_t13515(val__$1,box__$1,meta13516){return (new cljs.core.async.impl.channels.t13515(val__$1,box__$1,meta13516));
});
}
return (new cljs.core.async.impl.channels.t13515(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__4123__auto__,writer__4124__auto__,opts__4125__auto__){return cljs.core._write.call(null,writer__4124__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__4120__auto__,writer__4121__auto__,opt__4122__auto__){return cljs.core._write.call(null,writer__4121__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_13518 = self__.takes.pop();if((taker_13518 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13518))
{var take_cb_13519 = cljs.core.async.impl.protocols.commit.call(null,taker_13518);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13519,taker_13518,this$__$1){
return (function (){return take_cb_13519.call(null,null);
});})(take_cb_13519,taker_13518,this$__$1))
);
} else
{}
{
